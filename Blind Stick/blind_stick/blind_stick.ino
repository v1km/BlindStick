const int trigger = 3; //Trigger pin of ultrasonic sensor
const int echo = 2; //Echo pin of ultrasonic sensor Sesnor
const int Buzz = 12; //positive pole of buzzer
const int Remote = A0; //Echo pin of 1st Sesnor
const int Light = A1; //ldr pin of  Sesnor
